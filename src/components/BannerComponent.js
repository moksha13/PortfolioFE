          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Moksha`} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Application Developer ", "Web Developer ", "UI/UX Designer " ]'><span className="wrap">{text}</span></span></h1>
